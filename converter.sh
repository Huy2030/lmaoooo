...
# Tự động bật tất cả các conversion options
export ITEM_CONVERSION="true"
export ARMOR_CONVERSION="true"
export FONT_CONVERSION="true"
export BOW_CONVERSION="true"
export CROSSBOW_CONVERSION="true"
export SHIELD_CONVERSION="true"
export BLOCK_CONVERSION="true"
export SOUND_CONVERSION="true"
export GUI_CONVERSION="true"
: ${ITEM_MODEL:="true"}
export OTHER_CONVERSION="turn on all"
export JSON_UNICODE_CONVERSION="true"
...
# Run JSON Unicode obfuscation AFTER jq minification (tự động chạy)
cd ..
